...
let imgs = {
    "Sunny": "./media/img5.png",
    "Clouds": "./media/img2.png",
    "Clear": "./media/img5.png",
    "Rain": "./media/img7.png",
    "Snow": "./media/img9.png",
    "Wind": "./media/img27.png",
    "Drizzle": "./media/img10.png",
    "Mist": "./media/img33.png",
    "Smoke": "./media/img33.png",
    "Dust": "./media/img33.png",
    "Fog": "./media/im33.png",
    "Thunderstorm": "./media/img13.png",
    "not found": "./media/error.png"
};
